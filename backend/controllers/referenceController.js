// referenceController.js - Extracted business logic from referenceRoutes.js
...
const getTrainerBatches = async (req, res) => {
  try {
...
const getStudentReferences = async (req, res) => {
  try {
...
const getStudentReferenceById = async (req, res) => {
  try {
    const studentId = req.user.id;
...
const rateReference = async (req, res) => {
  try {
    const studentId = req.user.id;
    const referenceId = req.params.id;
...
const getReferenceAnalytics = async (req, res) => {
  try {
    const reference = await Reference.findById(req.params.id).populate([
      {

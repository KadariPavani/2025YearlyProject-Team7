...
const submissionSchema = new mongoose.Schema({
    ...
    // Whether this submission represents a finalization of the contest for the user
    isFinal: {
        type: Boolean,
        default: false
    },
    // Whether this submission was created from a saved "run" (one-time quick run saved to show on leaderboard)
    isRun: {
        type: Boolean,
        default: false
    }

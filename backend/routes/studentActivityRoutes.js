  ...
  try {
    ...
    return {
      student: {
        ...
        batchName: batchName // ✅ NEW: Include batch name
      },
      scores: {
        quizzes: quizScores,
...
router.get('/trainer', generalAuth, async (req, res) => {
  try {
    ...
    // ✅ FIXED: Properly populate placementTrainingBatchId
...
// ============================================
// ROUTE 3: COORDINATOR - Get student activity for assigned batch
// ============================================
// @route   GET /api/student-activity/coordinator
// @desc    Get student activity for coordinator's assigned batch
// @access  Private (Coordinator only)
router.get('/coordinator', generalAuth, async (req, res) => {
  try {

...
<div className="md:grid md:grid-cols-2 md:gap-6 flex flex-col gap-6 items-start">
  {faqs.map((faq, i) => (
    <div
      key={i}
      className="bg-blue-50 shadow-md rounded-xl p-6 hover:shadow-xl transition-shadow duration-300 w-full md:w-auto"
    >
      <button
        onClick={() => toggleFAQ(i)}

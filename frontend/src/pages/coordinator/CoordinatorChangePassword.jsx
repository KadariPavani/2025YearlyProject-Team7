...
const CoordinatorChangePassword = () => {
  ...
  const header = useHeaderData('coordinator');
          ...
          <form onSubmit={handleChangePassword} className="space-y-6">
            ...
            <div className="flex space-x-4 pt-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-orange-600 text-white py-3 rounded-lg hover:bg-orange-700 transition-colors disabled:opacity-50 font-medium flex items-center justify-center"
              >
                {loading ? (
                  <>
